    ...
    <nav className="w-full flex justify-center bg-white fixed top-0 z-50  ">
      <div className="  sm:w-full md:w-full lg:w-4/5 xl:w-5/6 px-2 md:px-0">
        <div className="flex  items-center font-medium w-full   justify-between">
          ...
          <div className=" max-w-[50px] z-50  md:w-auto  w-full flex justify-between ">
            <div className=" flex items-center">
              <a href="tel:+919999416316" className="text-[#384152] hover:text-[#313a49]">
                <PhoneCall className="text-5xl" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className=" bg-white text-black fixed top-0 w-full z-50">
        <div className="w-full items-center flex justify-between">
          ...
          <div className="md:hidden flex items-center">
            <a href="tel:+919999416316" className="text-[#384152] hover:text-[#313a49]">
              <PhoneCall className="text-4xl ml-[150px]" />
            </a>
          </div>
          <div>
            {open ? (
        ...
        {/* Mobile view  */}
        <div
          className={`md:hidden  bg-white  w-[70%] h-full bottom-0 duration-500 ${open
